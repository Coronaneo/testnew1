subroutine nufft3dII(nj,x,iflag,ns,rt,tol,U,V,xsub,r)
implicit none

integer :: ns,rt,iflag,nj,k(ns*ns*ns,3),j,r,xsub(nj),i,xxsub(nj)
real  :: tol
real*8 pi,x(nj)
parameter (pi=3.141592653589793238462643383279502884197d0)
complex*16 fftconst,U(nj,r),V(ns*ns*ns,r)
complex*16 M(nj,ns*ns*ns)
...
&     k(j,2)*(x(i,2)-floor(x(i,2)+0.5))+k(j,3)*(x(i,3)-floor(x(i,3)+0.5))))
   enddo
enddo
...
subroutine nufft3dIIapp(nj,c,U,V,xxsub,ns,iflag,r,S,plan)
implicit none
integer  r,i,j,k,nj,ns,iflag,num
integer mm
integer xsub(nj),Xsub(nj,ns*ns*ns)
complex*16 M(ns*ns*ns,r),N(ns*ns*ns,r),S(nj),c(ns*ns*ns),U(nj,r),V(ns*ns*ns,r)
